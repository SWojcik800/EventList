    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LectureLecturer", x => new { x.LecturersId, x.LecturesId });
                    table.ForeignKey(
                        name: "FK_LectureLecturer_Lecturers_LecturersId",
                        column: x => x.LecturersId,
                        principalTable: "Lecturers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LectureLecturer_Lectures_LecturesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LectureLecturer_LecturesId",
                table: "LectureLecturer",
                column: "LecturesId");
